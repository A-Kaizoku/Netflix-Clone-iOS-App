...
class TitleTableViewCell: UITableViewCell {
    ...
    private let titleLabel: UILabel = {
        ...
        /// try to implement something like if the label text exceeds certain charac limit it automatically truncatexs itself
        /// One method can be, we can use stack views
